      ...
      <div className='bg-stone-50 dark:bg-zinc-800 p-5 w-full tiny:max-w-[400px] sm:max-w-[400px] md:max-w-[400px] border-t-4 border-[#3d95ec] rounded-lg shadow-lg'>
        <div className='flex flex-col gap-[15px]'>
          ...
          <form onSubmit={handleSubmit(saveUser)} className='flex flex-col gap-[10px]'>
            ...
            <div className='relative'>
            <div className='absolute left-[8px] top-[12px] bg-black dark:bg-white' style={customStyles.checkboxWrapper}></div>
            ...
            <Button aria-busy={isSubmitting} disabled={isSubmitting} className='bg-[#3d95ec] text-white hover:bg-[#5994cf]' type='submit'>
          ...
          <div>
            <Link className="text-sm mt-3 text-right" href={`/${locale}/sign-in`}>
              {t("TextLinkToSignIn")} <span className="underline text-[#3d95ec]">Sign In</span>
            </Link>
          </div>
        </div>
      </div>
